...
class CalculatorServiceTest {
    ...
    fun percentage() {
        // Given
        val wheel = WheelEntity(0, NAME, BT_NAME, BT_ADDR, MILEAGE, VOLTAGE_MIN, VOLTAGE_MAX)
    ...
    private fun percentage_whenVoltagesNotSet_zero(voltageMin: Float, voltageMax: Float) {
        // Given
        val wheel = WheelEntity(0, NAME, BT_NAME, BT_ADDR, MILEAGE, voltageMin, voltageMax)
