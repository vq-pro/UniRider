...
object TestDomain {
    ...
    val S18_1 = WheelEntity(ID, NAME, DEVICE_NAME, DEVICE_ADDR, PREMILEAGE, MILEAGE, WH, VOLTAGE_MIN, VOLTAGE_MAX)
    val S20_2 = WheelEntity(ID2, NAME2, DEVICE_NAME2, DEVICE_ADDR2, PREMILEAGE2, MILEAGE2, WH2, VOLTAGE_MIN2, VOLTAGE_MAX2)
    val SHERMAN_MAX_3 = WheelEntity(ID3, NAME3, DEVICE_NAME3, DEVICE_ADDR3, PREMILEAGE3, MILEAGE3, WH3, VOLTAGE_MIN3, VOLTAGE_MAX3)

    val S18_DISCONNECTED = WheelEntity(ID, NAME, null, null, PREMILEAGE, MILEAGE, WH, VOLTAGE_MIN, VOLTAGE_MAX)
}
