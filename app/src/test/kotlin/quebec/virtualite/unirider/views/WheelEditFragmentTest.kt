...
class WheelEditFragmentTest : FragmentTestBase(WheelEditFragment::class.java) {
    ...
    fun onViewCreated() {
        ...
        verifyOnUpdateText(mockedEditChargeAmperage)
        verifyOnUpdateText(mockedEditChargeRate)
        verifyOnUpdateText(mockedEditDistanceOffset)
        verifyOnUpdateText(mockedEditName)
        verifyOnUpdateText(mockedEditPreMileage)
        verifyOnUpdateText(mockedEditMileage)
        verifyOnUpdateText(mockedEditVoltageFull)
        verifyOnUpdateText(mockedEditVoltageMax)
        verifyOnUpdateText(mockedEditVoltageMin)
        verifyOnUpdateText(mockedEditWh)
        verifyOnToggleSwitch(mockedSwitchSold)
        verifyOnLongClick(mockedButtonDelete)
        verifyOnClick(mockedButtonSave)
