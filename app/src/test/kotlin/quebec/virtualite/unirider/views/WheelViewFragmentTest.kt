...
class WheelViewFragmentTest : BaseFragmentTest(WheelViewFragment::class.java) {
    ...
    fun onViewCreated() {
        ...
        verifyFieldAssignment(R.id.edit_voltage_actual_on_view, fragment.editVoltageActual, mockedEditVoltageActual)
    ...
    private fun mockFields() {
        ...
        mockField(R.id.edit_voltage_actual_on_view, mockedEditVoltageActual)
