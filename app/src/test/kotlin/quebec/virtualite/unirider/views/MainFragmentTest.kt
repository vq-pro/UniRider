...
import quebec.virtualite.unirider.test.domain.TestConstants.ABRAMS_4
...
import quebec.virtualite.unirider.test.domain.TestConstants.MILEAGE3
import quebec.virtualite.unirider.test.domain.TestConstants.MILEAGE4
...
import quebec.virtualite.unirider.test.domain.TestConstants.NAME_SOLD
...
import quebec.virtualite.unirider.test.domain.TestConstants.WHEEL_ROW_S20_2_123
import quebec.virtualite.unirider.test.domain.TestConstants.WHEEL_ROW_SHERMAN_MAX_3
...
class MainFragmentTest : FragmentTestBase(MainFragment::class.java) {
    ...
    fun onViewCreated() {
        ...
        verifyMultiFieldListAdapter<WheelRow>(mockedLVWheels, R.layout.wheels_item)
        verifyOnItemClick(mockedLVWheels)
