...
Feature: Wheel Connecting - End-2-End
  ...
  Scenario Outline: <wheel> - Connecting to a wheel for the first time
    Given these wheels:
...
#      | KingSong 14S    | KS-14SMD2107 | 759     |
      | KingSong S18 | KS-14SMD2107 | 759     |
#      | Veteran Sherman | LK1149       | 14590   |

  Scenario Outline: <wheel> - Connecting to a previously connected wheel
